...
export default function TransactionAnalyticsAltPage() {
  ...
  return (
    <div className="p-6">
      ...
      {/* Volume Chart and History Table Section */}
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
              <div className="hidden sm:flex items-center bg-gray-50 rounded-lg p-1 border border-gray-200">
                <button
                  disabled={loading}
                  className="px-3 py-1.5 text-sm font-semibold text-gray-900 bg-white rounded-md shadow-sm transition disabled:opacity-50"
                >
                  Daily
                </button>
                <button
                  disabled={loading}
                  className="px-3 py-1.5 text-sm font-medium text-gray-500 rounded-md hover:text-gray-700 transition disabled:opacity-50"
                >
                  Monthly
                </button>
                <button
              ...
              <button
                disabled={loading}
                className="flex items-center px-3 py-2 border border-gray-200 rounded-lg text-sm text-gray-600 hover:bg-gray-50 transition disabled:opacity-50 disabled:cursor-not-allowed"
              >
