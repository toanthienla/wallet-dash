...
const AppHeader: React.FC = () => {
  ...
  const toggleSidebar = () => {
    // Gửi sự kiện global để AppSidebar bắt được
          ...
          <div className="hidden xl:block">
            <form>
              <div className="relative">
                ...
                />
                <button className="absolute right-2.5 top-1/2 inline-flex -translate-y-1/2 items-center gap-0.5 rounded-lg border border-gray-200 bg-gray-50 px-[7px] py-[4.5px] text-xs -tracking-[0.2px] text-gray-500 dark:border-gray-800 dark:text-gray-400">
                  <span>⌘</span>
                  <span>K</span>
                </button>
              </div>
